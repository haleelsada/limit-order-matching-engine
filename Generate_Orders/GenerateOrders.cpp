...
void GenerateOrders::setOutputDirectory(const std::string& directory)
{
...
{
    file.open(outputDirectory + "/orders.txt");
...
{
    std::ofstream file(outputDirectory + "/initialOrders.txt");
